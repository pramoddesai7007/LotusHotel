...
const PaymentModal = ({
  ...
  const fetchMobileNumbers = async () => {
    try {
      const response = await axios.get(
        "https://lotusbackend.vercel.app/api/customer/mobile-numbers"
      );
    ...
    try {
      ...
      if (formData.mobileNumber) {
        const customerResponse = await axios.get(
          `https://lotusbackend.vercel.app/api/customer/get-customer-by-mobile/${formData.mobileNumber}`
        );
      ...
      if (formData.mobileNumber && parseFloat(formData.dueAmount) > 0) {
        ...
        if (updatedCreditBalance > 0) {
          await axios.patch(
            `https://lotusbackend.vercel.app/api/customer/update-credit-balance/${existingCustomer._id}`,
            {
      ...
      const response = await axios.patch(
        `https://lotusbackend.vercel.app/api/order/update-order-by-id/${orderID}`,
        {
          ...formData,
      ...
      // await axios.put(`https://lotusbackend.vercel.app/api/table/${tableId}`, {
      //   isCalled: false,
      // });
  ...
  const addNewCustomer = async () => {
    ...
    const newCustomerResponse = await axios.post(
      "https://lotusbackend.vercel.app/api/customer/customer/list/add-customer",
      {
        customerName: formData.customerName,
        mobileNumber: formData.mobileNumber,
  ...
  const fetchCustomerDetails = async (mobileNumber) => {
    try {
      const response = await axios.get(
        `https://lotusbackend.vercel.app/api/customer/get-customer-by-mobile/${mobileNumber}`
      );
  ...
  const handlePaymentMethodClick = async () => {
    try {
      ...
      await axios.put(`https://lotusbackend.vercel.app/api/order/order/update-flag/${orderNumber}`);
